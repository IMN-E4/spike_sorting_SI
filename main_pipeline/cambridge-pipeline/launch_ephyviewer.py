...
base_folder = Path("/home/samuel/DataSpikeSorting/eduarda/Cambridge_Recordings/")
...
def open_my_viewer(bird_name, session_name, parent=None):


    data_folder = base_folder / f'{bird_name}/Recordings/{session_name}/Record Node 101/'
